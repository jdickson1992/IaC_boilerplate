...
If you executed `deploy.sh` with option **1**, you woykd have just generated a fully provisioned IaC environment with a running Docker stack! 🎉

To get onto those machines (managers / workers), use the `test.pem` file generated by terraform.
